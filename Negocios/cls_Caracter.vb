...
Public Class cls_Caracter
    Public Function IngresarCaracter(ByVal nombre As String) As String
        ...
        'End If
        NomParam.Add("@Bloque") : ValParam.Add("IngresarCaracter")
    ...
    Public Function EliminarCaracter(ByVal CaracterId As Integer) As String
        ...
        NomParam.Add("@Bloque") : ValParam.Add("EliminarCaracter")
        NomParam.Add("@AmbitoId") : ValParam.Add(CaracterId)
    ...
    Public Function EditarCaracter(ByVal nombre As String, ByVal CaracterId As Integer) As String
        ...
        prueba = ""
        NomParam.Add("@Bloque") : ValParam.Add("EditarCaracter")
        NomParam.Add("@Nombre") : ValParam.Add(nombre)
        NomParam.Add("@AmbitoId") : ValParam.Add(CaracterId)
        consulta.ExecuteSQL("IE_ANOTACION", NomParam, ValParam)
        Return "El comando N° 150 fue ejecutado con éxito."
    ...
    Public Function GetData2() As String
        ...
        NomParam.Add("@Bloque") : ValParam.Add("GetData2")
