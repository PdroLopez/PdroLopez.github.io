<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Enseñanza.aspx.vb"  MasterPageFile="~/Inicio.Master" Inherits="iEdeucaLCD.Enseñanza" %>
...
<script>
    $(document).ready(function () {
        ...
        $('#btnAgregar').click(function () {
            ...
            var tipoEnseñanza = $('#tipo').val();
            var tipo_organizacion = 45;
            $.ajax({
                type: "POST", 
                url: '/Organizacion.asmx/IngresarTipoEnseñanza',
                data: "{tipoEnseñanza:'" + tipoEnseñanza +
        ...
        function listar() {
            ...
            $.ajax({
                type: "POST",
                url: 'Organizacion.asmx/MostrarTipoEnseñanza',
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card-title">
                                <h3 class="card-label">Tipo de Enseñanza</h3>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card-title">
        ...
        <div class="modal-dialog modal-xl" role="document" style="text-align:left;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Nuevo Tipo de Enseñanza
                    </h5>
