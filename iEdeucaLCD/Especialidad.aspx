<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Especialidad.aspx.vb" MasterPageFile="~/Inicio.Master" Inherits="iEdeucaLCD.Especialidad" %>
...
<script>
    $(document).ready(function () {
        ...
        $('#btnAgregar').click(function () {
            ...
            var tipo_organizacion = 43;
            $.ajax({
                type: "POST", 
                url: '/Organizacion.asmx/IngresarEspecialidad',
        ...
        function listar() {
            ...
            $.ajax({
                type: "POST",
                url: 'Organizacion.asmx/MostrarEspecialidad',
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card-title">
                                <h3 class="card-label">Especialidad</h3>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card-title">
        ...
        <div class="modal-dialog modal-xl" role="document" style="text-align:left;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Nueva Especialidad
                    </h5>
                    ...
                    <form class="needs-validation was-validated" novalidate="" id="form_valid" name="form_valid">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-12">
                                ...
                                <input type="text" class="form-control" id="especialidad" name="tipo" required="">
