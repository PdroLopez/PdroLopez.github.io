<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TipoCurso.aspx.vb"  MasterPageFile="~/Inicio.Master" Inherits="iEdeucaLCD.TipoCurso" %>
...
<script>
    $(document).ready(function () {
        ...
        $('#btnAgregar').click(function () {
            ...
            var tipo_organizacion = 44;
            $.ajax({
                type: "POST", 
                url: '/Organizacion.asmx/IngresarTipoCurso',
        ...
        function listar() {
            ...
            $.ajax({
                type: "POST",
                url: 'Organizacion.asmx/MostrarTipoCurso',
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card-title">
                                <h3 class="card-label">Tipo de Curso</h3>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card-title">
        ...
        <div class="modal-dialog modal-xl" role="document" style="text-align:left;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Nuevo Tipo de Curso
                    </h5>
                    ...
                    <form class="needs-validation was-validated" novalidate="" id="form_valid" name="form_valid">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-12">
                                ...
                                <input type="text" class="form-control" id="tipoCurso" name="tipo" required="">
