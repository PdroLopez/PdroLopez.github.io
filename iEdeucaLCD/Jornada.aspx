<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Jornada.aspx.vb" MasterPageFile="~/Inicio.Master" Inherits="iEdeucaLCD.Jornada" %>
...
<script>
    $(document).ready(function () {
        ...
        $('#btnAgregar').click(function () {
            ...
            var tipo_organizacion = 39;
            $.ajax({
                type: "POST", 
                url: '/Organizacion.asmx/IngresarJornada',
        ...
        function listar() {
            ...
            $.ajax({
                type: "POST",
                url: 'Organizacion.asmx/MostrarJornada',
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="card-title">
                                <h3 class="card-label">Jornada Escolar</h3>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card-title">
        ...
        <div class="modal-dialog modal-lg" role="document" style="text-align:left;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Nueva Jornada Escolar
                    </h5>
